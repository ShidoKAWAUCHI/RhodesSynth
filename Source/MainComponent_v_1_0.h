...
private:
    ...
    //enami added start
    double currentLevel = 0.1, A3Frequency = 440.0;
    float level = 0.1f;
    //enami added end
};
...
public:
    ...
    MainComponent()  : synthAudioSource (keyboardState), keyboardComponent (keyboardState, juce::MidiKeyboardComponent::horizontalKeyboard)
    {
        ...
        targetLevel = currentLevel / 0.125f;
        keyboardComponent.setVelocity (targetLevel, false);
        levelSlider.onValueChange = [this] {
            targetLevel = (float)levelSlider.getValue() / 0.125f;
            keyboardComponent.setVelocity (targetLevel, false);
        };
        ...
        A3FrequencySlider.setRange(430.0, 450.0);
        A3FrequencySlider.setValue((double)currentA3Frequency, juce::dontSendNotification);
        A3FrequencySlider.setSkewFactorFromMidPoint(440.0);
        A3FrequencySlider.onValueChange = [this] {
            targetA3Frequency = (float)A3FrequencySlider.getValue();
        };
...
private:
    ...
    //enami added start
    float currentLevel = 0.1f, targetLevel = 0.1f, currentA3Frequency = 440.0f, targetA3Frequency = 440.0f;
    //enami added end
